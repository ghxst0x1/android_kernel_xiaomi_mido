...
void hdd_wlan_exit(hdd_context_t *pHddCtx)
{
   ...
   //unregister_netdevice_notifier(&hdd_netdev_notifier); //KPFix1
   
   //hdd_stop_all_adapters( pHddCtx ); //KPFix2
...
//err_reg_netdev:
//   unregister_netdevice_notifier(&hdd_netdev_notifier); //KPFix5
